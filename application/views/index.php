...
(function(){
	...
	if(Public.isIE6) {
		 var Oldbrowser = {
			 ...
			 addDom: function() {
			 	var html = $('<div id="browser">您所使用的瀏覽器版本過低，影響系統的正常運行，建議更換為<a href="http://www.google.cn/chrome/intl/zh-CN/landing_chrome.html" target="_blank">Google Chrome</a>、<a href="http://download.microsoft.com/download/4/C/A/4CA9248C-C09D-43D3-B627-76B0F6EBCD5E/IE9-Windows7-x86-chs.exe" target="_blank">IE9</a>、或者<a href=http://firefox.com.cn/" target="_blank">火孤瀏覽器</a>，以便達到更好的效果。<a id="bClose" title="Close">x</a></div>').insertBefore('#container').slideDown(500); 
			 	this._colse();
			 },
			 _colse: function() {
...
function markupVension(){
	var imgSrcList = {
				...
				base:'<?php echo base_url()?>statics/css/<?php echo sys_skin()?>/img/icon_v_b_e.png',	//基础版正式版
...
<div id="container" class="cf">
  <div id="col-side">
    <ul id="nav" class="cf">
      <li class="item item-sales"> <a href="javascript:void(0);" class="sales main-nav">出貨<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
          <ul class="sub-nav" id="sales">
          </ul>
        </div>
      </li>
      <li class="item item-purchase"> <a href="javascript:void(0);" class="purchase main-nav">入貨<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
          <ul class="sub-nav" id="purchase">
          </ul>
        </div>
      </li>
      <li class="item item-storage"> <a href="javascript:void(0);" class="storage main-nav">庫存<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
          <ul class="sub-nav" id="storage">
          </ul>
        </div>
      </li>           
      <li class="item item-money"> <a href="javascript:void(0);" class="money main-nav">財務<span class="arrow">&gt;</span></a>
        <div class="sub-nav-wrap single-nav">
