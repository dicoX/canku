...
function callback() {
    ...
    if (isSingle) {
        ...
        for (rowid in addList) {
            ...
            o && parent.$("#" + k).data("goodsInfo", n).data("storageInfo", {
                id: i.locationId,
                name: i.locationName,
                price:i.salePrice
            }).data("unitInfo", {
...
var api = frameElement.api,
    ...
    THISPAGE = {
        ...
        loadGrid: function () {
            function a(a, b, c) {
                var d = '<div class="operating" data-id="' + c.id + '"><a class="ui-icon ui-icon-search" title="檢索"></a><span class="ui-icon ui-icon-copy" title="商品圖片"></span></div>';
                return d
            }
