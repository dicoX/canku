  ...
  <div class="search-wrap" id="report-search">
      ...
      <div class="fl"> <strong class="tit mrb fl">查詢條件：</strong>
        <div class="ui-btn-menu fl" id="filter-menu"> <span class="ui-btn menu-btn"> <strong id="selected-period">請選擇查詢條件</strong><b></b> </span>
          <div class="con">
            ...
            <div class="btns"> <a href="#" id="conditions-trigger" class="conditions-trigger" tabindex="-1">更多條件<b></b></a> <a class="ui-btn ui-btn-sp" id="filter-submit" href="#">确定</a> <a class="ui-btn" id="filter-reset" href="#" tabindex="-1">重置</a> </div>
          </div>
        </div>
	...
	<div class="ui-print">
		<div class="grid-wrap" id="grid-wrap">
			<div class="grid-title">採購入貨匯總表（按供應商）</div>
