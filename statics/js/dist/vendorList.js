...
function initGrid() {
	var a = Public.setGrid(),
		b = ["操作", "供應商編號", "供應商名稱", "供應商類型", "首要聯絡人", "手提電話", "座機", "QQ/MSN", "期初往來餘額", "狀態"],
...
var searchFlag = !1,
	filterClassCombo, catorageCombo, handle = {
		...
		del: function(a) {
			$.dialog.confirm("刪除的供應商資料將不能恢復，請慎重！", function() {
