var curRow, curCol, curArrears, loading, urlParam = Public.urlParam(),
	...
	THISPAGE = {
		...
		initDom: function(a) {
			...
			}), this.$_toolBottom.html("edit" === a.status ? '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/invOi/toCBTZPdf?action=toCBTZPdf&id=' + a.id + '" target="_blank" id="print" class="ui-btn mrb">列印</a><a id="edit" class="ui-btn">儲存</a>' : '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/invOi/toCBTZPdf?action=toCBTZPdf&id=' + a.id + '" target="_blank" id="print" class="ui-btn mrb">列印</a><a class="ui-btn-prev mrb" id="prev" title="前一張"><b></b></a><a class="ui-btn-next" id="next" title="后一張"><b></b></a>'), this.salesListIds = parent.salesListIds || [], this.idPostion = $.inArray(String(a.id), this.salesListIds), this.idLength = this.salesListIds.length, 0 === this.idPostion && $("#prev").addClass("ui-btn-prev-dis"), this.idPostion === this.idLength - 1 && $("#next").addClass("ui-btn-next-dis"), this.$_userName.html(a.userName)) : (this.$_toolBottom.html('<a id="savaAndAdd" class="ui-btn ui-btn-sp mrb">儲存&新增</a><a id="save" class="ui-btn">儲存</a>'), this.$_userName.html(SYSTEM.realName || ""))
		},
		loadGrid: function(a) {
			function b(a, b, c) {
		...
		addEvent: function() {
			...
			this.$_date.bind("keydown", function(a) {
				...
				b.test($(this).val()) || (parent.Public.tips({
					type: 2,
					content: "日期格式有誤！正確示例：2016-08-08。"
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-prev-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有前一張了！"
				}), !1) : (a.idPostion = a.idPostion - 1, 0 === a.idPostion && $(this).addClass("ui-btn-prev-dis"), loading = $.dialog.tips("數據加載中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invOi/updateCbtz?action=updateCbtz&type=cbtz", {
