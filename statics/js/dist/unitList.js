	...
	$("#grid").jqGrid({
		...
		loadComplete: function(a) {
			if (a && 200 == a.status) {
				...
				var e = 250 == a.status ? "未設置計量單位！" : "未能讀取計量單位數據！" + a.msg;
				parent.Public.tips({
					type: 2,
					content: e
				})
...
function groupManager(a, b, c) {
	title = "add" === a ? "新增" : "編輯", parent.$.dialog({
		title: title + "計量單位組",
...
var defaultPage = Public.getDefaultPage(),
	...
	handle = {
		...
		del: function(a) {
			...
			$.dialog.confirm("刪除的計量單位將不能恢復，請謹慎操作！", function() {
