...
<div class="wrapper">
	<div class="mod-search cf">
	    <div class="fl">
	      <ul class="ul-inline">
	        <li>
	          <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="輸入商品編號、名稱、規格型號等相關資料檢索">
	        </li>
	        <li><a class="ui-btn mrb" id="search">檢索</a></li>
	      </ul>
	    </div>
	    <div class="fr"><a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add">新增</a><!--<a href="#" class="ui-btn mrb" id="btn-print">打印</a>--><a class="ui-btn mrb" id="btn-disable">停用</a><a class="ui-btn mrb" id="btn-enable">啓用</a><!--<a href="#" class="ui-btn mrb" id="btn-import">导入</a>--><a href="#" class="ui-btn mrb" id="btn-export">導出</a><a href="#" class="ui-btn" id="btn-batchDel">刪除</a></div>
	  </div>
	  <div class="cf">
	    <div class="grid-wrap fl cf">
	    	<h3>當前類別：<span id='currentCategory'></span><a href="javascript:void(0);" id='hideTree'>&gt;&gt;</a></h3>
		    <table id="grid">
		    </table>
		    <div id="page"></div>
		</div>
		<div class="fl cf" id='tree'>
			...
			<div class="quickSearchField dn">
				<form class="ui-search" id="searchCategory">
					<input type="text" class="ui-input" /><button type="submit" title="點擊檢索" >檢索</button>
				</form>
			</div>
		</div>
	</div>
