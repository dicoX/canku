...
<div class="print-settings-wrap">
  ...
  <div class="settings-ctn" id="printSettings">
      <div class="item">
        <p class="print-tips">爲了確保能夠正常列印，請預先下載幷安裝<a href="http://dl.pconline.com.cn/html_2/1/81/id=1322&pn=0&linkPage=1.html" target="_blank">Adobe PDF閱讀器</a>。</p>
        <ul class="mod-form-rows" id="pdfSettings">
          <li class="row-item">
            ...
            <div class="ctn-wrap">
              <span class="radio-wrap"><input type="radio" name="paperType"  value="" checked="checked"/><labe>A5</label></span>
            </div>
          </li>
          <!--<li class="row-item">
            <div class="label-wrap">
...
<script>
 (function($){
    ...
    function tadaoPrint(){
      if (parent.parent.SYSTEM.serviceType == 8) {
    	parent.parent.Public.tips({type: 1,content: '此版本不提供套打功能'});
        return ;
      }
