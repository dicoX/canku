...
<div class="wrapper">
  <div class="mod-search cf">
    <div class="fl">
      <ul class="ul-inline">
        <li>
          <input type="text" id="matchCon" class="ui-input ui-input-ph" value="請輸入單據編號/供應商名稱/備註">
        </li>
        <li>
          <label>日期:</label>
    ...
    <div class="fr"><a class="ui-btn ui-btn-sp" id="add">新增</a><a class="ui-btn" id="print" target="_blank" href="javascript:void(0);">列印</a><a class="ui-btn" id="export" target="_blank" href="javascript:void(0);">導出</a><a class="ui-btn dn" id="audit">審覈</a><a class="ui-btn" id="reAudit">反審覈</a></div>
  </div>
