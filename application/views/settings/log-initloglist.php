  ...
  <div class="mod-search cf">
    <div class="s-inner cf">
      <div class="fl"> <strong class="tit mrb fl">查詢條件：</strong>
        <div class="ui-btn-menu fl" id="filter-menu"> <span class="ui-btn menu-btn"> <span id="selected-date">請選擇查詢條件</span><b></b> </span>
          <div class="con">
            <ul class="filter-list">
              <li>
                <label class="tit">日期：</label>
                <input type="text" value="2015-04-20" class="ui-input ui-datepicker-input" readonly name="beginDate" id="beginDate" />
                <span>至</span>
                <input type="text" value="2015-04-26" class="ui-input ui-datepicker-input" readonly name="endDate" id="endDate" />
              </li>
            </ul>
            <ul class="filter-list" id="more-conditions">
              <li>
                  <label  class="tit" for="filter-user">操作員：</label>
