...
Public.operFmatter = function (val, opt, row) {
	var html_con = '<div class="operating" data-id="' + row.id + '"><span class="ui-icon ui-icon-pencil" title="編輯"></span><span class="ui-icon ui-icon-trash" title="刪除"></span></div>';
	return html_con;
};

Public.billsOper = function (val, opt, row) {
	var html_con = '<div class="operating" data-id="' + opt.rowId + '"><span class="ui-icon ui-icon-plus" title="增加列"></span><span class="ui-icon ui-icon-trash" title="刪除列"></span></div>';
	return html_con;
};
Public.billsOper_goods = function (val, opt, row) {
	var html_con = '<div class="operating" data-id="' + opt.rowId + '"><span class="ui-icon ui-icon-plus" title="增加列"></span><span class="ui-icon ui-icon-trash" title="刪除列"></span><span class="ui-icon ui-icon-cart" title="查看庫存"></span></div>';
	return html_con;
};
	...
	if(type !== 'assemble') {
		...
		$('.grid-wrap').on('click', '.goods .ui-icon-ellipsis', function(e){
			...
			$.dialog({
					...
					lock: true,
					button:[{name: '選入',defClass:'ui_state_highlight fl', callback: function () {
						this.content.callback(type);
				        return false;
					}},
					{name: '選入&關閉',defClass:'ui_state_highlight', callback: function () {
						this.content.callback(type);
						this.close();
				        return false;
					}},
...
Business.filterSuppliers = function(){
