...
<div class="mod-report">
  <div class="search-wrap" id="report-search">
    <div class="s-inner cf">
      <div class="fl"> <strong class="tit mrb fl">查詢條件：</strong>
        <div class="ui-btn-menu fl" id="filter-menu"> <span class="ui-btn menu-btn"> <strong id="selected-period">請輸入查詢條件</strong><b></b> </span>
          <div class="con">
 ...
 id="storageAuto"/><span class="ui-icon-ellipsis"></span></span>
            ...
            <div class="btns"> <a href="#" id="conditions-trigger" class="conditions-trigger" tabindex="-1">更多條件<b></b></a> <a class="ui-btn ui-btn-sp" id="filter-submit" href="#">確定</a> <a class="ui-btn"
...
></span> </div>
	...
	<div class="ui-print">
		<div class="grid-wrap" id="grid-wrap">
			<div class="grid-title">採購入貨匯總表（按商品）</div>
