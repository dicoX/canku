...
<div class="wrapper">
  ...
  <div class="bills">
    ...
    <div id="standardVersion" class="dn">
        <div class="tr" style="margin:0 -10px 10px 0; "><a class="ui-btn" id="selectSource">選擇源單</a>
</div>
...
:0 -6px; ">
   ...
   <div class="con-footer cf">
      <div class="mb10">
          <textarea type="text" id="note" class="ui-input ui-input-ph">暫無備註內容</textarea>
      </div>
