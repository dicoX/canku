    	...
    	<form id="manage-form" action="">
    		...
    		<ul class="mod-form-rows">
    			<li class="row-item pb0">
    				...
    				<div class="ctn-wrap"><textarea name="" id="note" class="ui-input ui-input-ph">添加備註信息</textarea></div>
    			</li>
    		</ul>
    	</form>
    </div>
...
<script src="<?php echo base_url()?>statics/js/dist/customerManage.js?ver=20150530"></script>
</body>
</html>
