...
INSERT INTO ci_log (`id`, `userId`, `ip`, `name`, `log`, `type`, `loginName`, `modifyTime`, `operateTypeName`, `adddate`) VALUES (217, 1, '192.168.1.104', '系統管理員', '备份与恢复,删除文件名:201506231554017.sql', 1, 'admin', '2016-04-24 00:45:56', '', '2016-04-24');
INSERT INTO ci_log (`id`, `userId`, `ip`, `name`, `log`, `type`, `loginName`, `modifyTime`, `operateTypeName`, `adddate`) VALUES (218, 1, '192.168.1.104', '系統管理員', '备份与恢复,删除文件名:201506231554133.sql', 1, 'admin', '2016-04-24 00:45:59', '', '2016-04-24');
INSERT INTO ci_log (`id`, `userId`, `ip`, `name`, `log`, `type`, `loginName`, `modifyTime`, `operateTypeName`, `adddate`) VALUES (219, 1, '192.168.1.104', '系統管理員', '备份与恢复,删除文件名:201507011121169.sql', 1, 'admin', '2016-04-24 00:46:01', '', '2016-04-24');
