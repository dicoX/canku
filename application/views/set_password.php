...
<div class="wrapper">
		...
		<form action="" id="set-password-form">
			<ul class="mod-form">
				...
				<li>
					...
					<input type="password" class="ui-input" placeholder="輸入登入密鑰" id="password"/>
					<p class="tip">*長度為8~20位，同時包含有數字、字母（區分大小寫），可使用特殊符號。</p>
				</li>
				<li>
					<label>確認密鑰：</label>
					<input type="password" class="ui-input" placeholder="再次輸入密鑰" id="confirm-password" />
				</li>
				<li id="btn-wrap">
	...
	<div class="success hide" id="success">
		<h3 class="tit">賬戶修改完畢！</h3>
		<p>你現時可以通過使用賬戶(<span class="userName"></span>)或者手提電話號碼(<span class="phone"></span>)進行登入操作。</p>
	</div>
