var curRow, curCol, curArrears, loading, urlParam = Public.urlParam(),
	...
	originalData, THISPAGE = {
		...
		initDom: function(a) {
			...
			}), this.$_toolBottom.html("edit" === a.status ? '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a id="edit" class="ui-btn mrb">儲存</a>' : '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a class="ui-btn-prev mrb" id="prev" title="前一張"><b></b></a><a class="ui-btn-next" id="next" title="后一張"><b></b></a>'), this.salesListIds = parent.salesListIds || [], this.idPostion = $.inArray(String(a.id), this.salesListIds), this.idLength = this.salesListIds.length, 0 === this.idPostion && $("#prev").addClass("ui-btn-prev-dis"), this.idPostion === this.idLength - 1 && $("#next").addClass("ui-btn-next-dis")) : this.$_toolBottom.html('<a id="savaAndAdd" class="ui-btn ui-btn-sp mrb">儲存&新增</a><a id="save" class="ui-btn">儲存</a>'), requiredMoney && ($("#accountWrap").show(), this.accountCombo = SYSTEM.isAdmin !== !1 || SYSTEM.rights.SettAcct_QUERY ? Business.accountCombo($("#account"), {
				width: 200,
				height: 300,
		...
		addEvent: function() {
			...
			this.customerCombo.input.enterKey(), this.$_date.bind("keydown", function(a) {
				...
				d && ("edit" === originalData.stata && (d.id = originalData.id, d.stata = "edit"), c.addClass("ui-btn-dis"), Public.ajaxPost("../scm/ori/addInc?action=addInc", {
					...
					c.removeClass("ui-btn-dis"), 200 === b.status ? (originalData.id = b.data.id, urlParam.id = b.data.id, a.$_toolBottom.html('<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a id="edit" class="ui-btn mrb">儲存</a>'), parent.Public.tips({
						content: "儲存完畢！"
					})) : parent.Public.tips({
						type: 1,
						content: b.msg
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-prev-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有前一張了！"
				}), !1) : (a.idPostion = a.idPostion - 1, 0 === a.idPostion && $(this).addClass("ui-btn-prev-dis"), loading = $.dialog.tips("數據加載中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/ori/updateInc?action=updateInc", {
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-next-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有后一張了！"
				}), !1) : (a.idPostion = a.idPostion + 1, a.idLength === a.idPostion + 1 && $(this).addClass("ui-btn-next-dis"), loading = $.dialog.tips("數據加載中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/ori/updateInc?action=updateInc", {
					id: a.salesListIds[a.idPostion]
				}, function(a) {
