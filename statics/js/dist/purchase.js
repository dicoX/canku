var curRow, curCol, loading, SYSTEM = system = parent.SYSTEM,
	...
	THISPAGE = {
		...
		initDom: function(a) {
			...
			var c = '<a id="savaAndAdd" class="ui-btn ui-btn-sp">儲存幷新增</a><a id="save" class="ui-btn">儲存</a>',
			...
			var h = '<a class="ui-btn-prev" id="prev" title="前一張"><b></b></a><a class="ui-btn-next" id="next" title="后一張"><b></b></a>';
		...
		addEvent: function() {
			...
			this.$_date.bind("keydown", function(a) {
				...
				if (a.preventDefault(), Business.verifyRight("PU_ADD")) {
					var b = "入貨單",
						c = "purchase-purchase";
					if ("150502" == originalData.transType) var b = "銷售退貨單",
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-prev-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有前一張了"
				}), !1) : (a.idPostion = a.idPostion - 1, 0 === a.idPostion && $(this).addClass("ui-btn-prev-dis"), loading = $.dialog.tips("數據加載中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invPu/update?action=update", {
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-next-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有后一張了"
				}), !1) : (a.idPostion = a.idPostion + 1, a.idLength === a.idPostion + 1 && $(this).addClass("ui-btn-next-dis"), loading = $.dialog.tips("數據加載中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invPu/update?action=update", {
					id: a.idList[a.idPostion]
				}, function(b) {
			...
			if (f.length > 0) {
				...
				if (taxRequiredCheck && (h.totalTax = $("#grid").jqGrid("footerData", "get").tax.replace(/,/g, ""), h.totalTaxAmount = $("#grid").jqGrid("footerData", "get").taxAmount.replace(/,/g, "")), requiredMoney) {
					...
					if (0 !== Number(h.rpAmount) && 0 === h.accId) return parent.Public.tips({
						type: 1,
						content: i + "不爲空時，請選擇結算賬戶。"
					}), !1;
					if (0 === Number(h.rpAmount) && 0 !== h.accId) return parent.Public.tips({
						type: 1,
						content: "結算賬戶不能爲空，請輸入" + i + "！"
					}), !1;
