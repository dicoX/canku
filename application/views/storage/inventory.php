...
<div class="wrapper">
 ...
 value='showZero'>含零庫存</label>
          <label class="chk" style="margin-top:6px; " title="顯示含序列號商品"><input type="checkbox" name="box"
 value='isSerNum'>序列號商品</label>
        </li>
        <li><a class="ui-btn ui-btn-sp mrb" id="search">檢索</a></li>
      </ul>
    </div>
    <div class="fr dn">
        <a class="ui-btn mrb" id="export">導出系統庫存</a><!--<a class="ui-btn mrb" id="import">导入盘点库存</a>--><a class
="ui-btn" id="save">生成盤點表格</a>
    </div>
  </div>
  <div class="grid-wrap">
    <table id="grid">
