...
var THISPAGE = {
	...
	initDom: function(a) {
		...
		var b = '<a id="savaAndAdd" class="ui-btn ui-btn-sp mrb">儲存&新增</a><a id="save" class="ui-btn">儲存</a>',
			c = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a id="edit" class="ui-btn mrb">儲存</a>',
	...
	addEvent: function() {
		...
		$(".wrapper").on("click", "#save", function(b) {
			...
			return b.preventDefault(), $(this).hasClass("ui-btn-prev-dis") ? (parent.Public.tips({
				type: 2,
				content: "已經沒有前一張了！"
			}), !1) : (a.idPostion = a.idPostion - 1, 0 === a.idPostion && $(this).addClass("ui-btn-prev-dis"), a.idPostion && (loading = $.dialog.tips("數據加載中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/receipt/update?action=update", {
			...
			return b.preventDefault(), $(this).hasClass("ui-btn-next-dis") ? (parent.Public.tips({
				type: 2,
				content: "已經沒有后一張了！"
			}), !1) : (a.idPostion = a.idPostion + 1, a.idLength === a.idPostion + 1 && $(this).addClass("ui-btn-next-dis"), a.idPostion && (loading = $.dialog.tips("數據加載中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/receipt/update?action=update", {
				id: a.paymentListIds[a.idPostion]
			}, function(a) {
