  ...
  <div class="mod-search cf">
    <div class="l">
      <ul class="ul-inline fix">
        ...
        <li><a class="ui-btn mrb" id="refresh">檢索</a></li>
      </ul>
    </div>
    <div class="r"><!-- <a href="#" class="ui-btn ui-btn-sp mrb fl" id="btn-print">打印</a> --><a href="#" class="ui-btn ui-btn-sp fl" id="btn-export">導出</a></div>
  </div>
  <div class="no-query"></div>
  	<!-- grid begin -->
	<div class="ui-print" style="display: none;">
		<div class="grid-wrap" id="grid-wrap">
			<div class="grid-title">庫存餘額表</div>
