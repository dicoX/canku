define(["jquery", "print"], function(a) {
	function b() {
		k.matchCon ? i("#matchCon").val(k.matchCon || "請輸入客戶/供應商/編號") : (i("#matchCon").addClass("ui-input-ph"), i("#matchCon").placeholder()), k.customer && i("#customer").attr("checked", !0), k.supplier && i("#supplier").attr("checked", !0), i("#search").on("click", function(a) {
			a.preventDefault();
			var b = "請輸入客戶/供應商/編號" === i("#matchCon").val() ? "" : i.trim(i("#matchCon").val());
			k = {
				matchCon: b,
