	...
	THISPAGE = {
		...
		initDom: function(a) {
			...
			var c = "",
				d = "",
				e = "";
			if (billRequiredCheck && (c = '<a class="ui-btn" id="audit">審覈</a>', d = '<a class="ui-btn" id="reAudit">反審覈</a>'), this.btn_audit = c, this.btn_reaudit = d, this.btn_tempSave = e, this.btn_add = '<a id="savaAndAdd" class="ui-btn ui-btn-sp mrb">儲存幷新增</a><a id="save" class="ui-btn">儲存</a>' + e, this.btn_edit = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/invOi/=toOoPdf?action=toOoPdf" target="_blank" id="print" class="ui-btn mrb">列印</a><a id="edit" class="ui-btn">儲存</a>', this.btn_view = '<a id="add" class="ui-btn ui-btn-sp mrb">新增</a><a href="../scm/invOi/=toOoPdf?action=toOoPdf" target="_blank" id="print" class="ui-btn mrb">列印</a>', this.btn_p_n = '<a class="ui-btn-prev mrb" id="prev" title="前一張"><b></b></a><a class="ui-btn-next" id="next" title="后一張"><b></b></a>', a.id > 0) {
		...
		addEvent: function() {
			...
			this.customerCombo.input.enterKey(), this.$_date.bind("keydown", function(a) {
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-prev-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有前一張了！"
				}), !1) : (a.idPostion = a.idPostion - 1, 0 === a.idPostion && $(this).addClass("ui-btn-prev-dis"), loading = $.dialog.tips("數據加載中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invOi/updateOut?action=updateOut&type=out", {
				...
				return b.preventDefault(), $(this).hasClass("ui-btn-next-dis") ? (parent.Public.tips({
					type: 2,
					content: "已經沒有后一張了！"
				}), !1) : (a.idPostion = a.idPostion + 1, a.idLength === a.idPostion + 1 && $(this).addClass("ui-btn-next-dis"), loading = $.dialog.tips("數據加載中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invOi/updateOut?action=updateOut&type=out", {
					id: a.salesListIds[a.idPostion]
				}, function(a) {
