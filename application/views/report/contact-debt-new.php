  ...
  <div class="search-wrap" id="report-search">
    <div class="s-inner cf">
        <div class="fl">
          <ul class="ul-inline">
            <li>
              <input type="text" id="matchCon" class="ui-input" value="請輸入客戶/供應商/編號">
            ...
            <li><a class="ui-btn mrb" id="search">檢索</a><!-- <a class="ui-btn ui-btn-refresh" id="refresh" title="刷新"><b></b></a> --></li>
          </ul>
        </div>
	...
	<div class="ui-print">
		<div class="grid-wrap" id="grid-wrap">
			<div class="grid-title">來往單位欠款表</div>
